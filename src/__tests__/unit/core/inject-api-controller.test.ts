...
describe("Test service injection", () => {
  test("Controller static properties", () => {
    return new Promise<void>((resolve, reject) => {
      ...
      const app = new MicroserviceTestApp<MicroserviceConfig>(rootFolder, {
        apiControllers: [InjectedTestController, TestControllerStatic],
      });
      ...
      app
        ...
        .then(() => {
          ...
          expect(TestControllerStatic.controller).toEqual(
            app.getApiController(InjectedTestController),
          );
          resolve();
        })
        .catch(error => {
  ...
  test("Controller instance properties", () => {
    return new Promise<void>((resolve, reject) => {
      ...
      const app = new MicroserviceTestApp<MicroserviceConfig>(rootFolder, {
        apiControllers: [InjectedTestController, TestControllerInstance],
      });
      ...
      app
        ...
        .then(() => {
          ...
          ).toEqual(app.getApiController(InjectedTestController));
          resolve();
        })
        .catch(error => {
          reject(error);
  ...
  test("Service static properties", () => {
    return new Promise<void>((resolve, reject) => {
      ...
      const app = new MicroserviceTestApp<MicroserviceConfig>(rootFolder, {
        apiControllers: [InjectedTestController],
